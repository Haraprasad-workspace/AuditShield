...
const CarouselCard = ({
  ...
  return (
    <motion.div
      ...
      <div
        className="mb-6 flex h-20 w-20 items-center justify-center rounded-[20px] border-[1.6px] border-[#ECECEC] bg-[#FEFEFE] shadow-[0_6px_20px_rgba(0,0,0,0.08)] transition-colors sm:mb-10 sm:h-24 sm:w-24 sm:rounded-[24px] dark:border-zinc-800 dark:bg-zinc-900">
        {item.icon(currentTheme)}
      </div>
      <h2
        className="mb-2 text-2xl font-bold text-[#010101] sm:text-[32px] dark:text-zinc-100">
        {item.title}
      </h2>
