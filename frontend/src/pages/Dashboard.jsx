...
import { 
  ShieldAlert, Globe, Cpu, Zap, Activity, 
  RefreshCw, ShieldCheck, Database, Search, 
  ArrowUpRight 
} from 'lucide-react'

const Dashboard = () => {
  const navigate = useNavigate() // Hook for button linking
  ...
  return (
    <div className="min-h-screen bg-cobalt-bg text-white font-sans selection:bg-cobalt-accent selection:text-white">
      ...
      <div className="ml-64 flex flex-col min-h-screen">
        ...
        <main className="p-8 space-y-8 flex-1 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="flex justify-between items-center bg-cobalt-surface/30 p-6 rounded-3xl border border-cobalt-border/50 backdrop-blur-md">
            <div className="flex items-center gap-6">
              <div>
                <h1 className="text-3xl font-heading font-black tracking-tighter uppercase">Security Console</h1>
                <p className="text-cobalt-muted text-[10px] font-black uppercase tracking-[0.2em] mt-1 flex items-center gap-2">
              ...
              <div className="hidden md:block">
                 <p className="text-[9px] font-black text-cobalt-muted uppercase tracking-widest">Last Integrity Scan</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            <div className="lg:col-span-7 bg-gradient-to-br from-cobalt-surface to-cobalt-bg border border-cobalt-border p-8 rounded-3xl flex items-center justify-between relative overflow-hidden shadow-2xl">
              ...
              <div className="z-10 space-y-4">
                <div>
                  <h3 className="text-cobalt-accent uppercase text-[10px] font-black tracking-[0.3em] mb-1">Audit Score</h3>
                ...
                <p className="text-sm text-cobalt-muted max-w-xs leading-relaxed font-medium">
                  Your architecture currently exceeds <span className="text-white font-bold">SOC2 Type II</span> baseline requirements.
                </p>
            ...
            <div className="lg:col-span-5 grid grid-cols-2 gap-4">
               {[
                 { label: 'Monitored Repos', val: stats.activeRepos, icon: <Globe size={18}/>, color: 'text-cobalt-accent' },
                 { label: 'Scanned Files', val: stats.scannedFiles.toLocaleString(), icon: <Database size={18}/>, color: 'text-risk-low' },
                 { label: 'Threats Blocked', val: stats.threatsBlocked, icon: <ShieldAlert size={18}/>, color: 'text-risk-high' },
                 { label: 'System Uptime', val: stats.uptime, icon: <Activity size={18}/>, color: 'text-white' }
               ].map((item, i) => (
                 <div key={i} className="bg-cobalt-surface/40 border border-cobalt-border p-5 rounded-2xl hover:border-cobalt-accent/50 transition-all group cursor-default">
          ...
          {/* --- MIDDLE ROW: ANALYTICS & REMEDIATION --- */}
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            <div className="xl:col-span-3 bg-cobalt-surface border border-cobalt-border p-8 rounded-3xl shadow-xl relative overflow-hidden">
              <div className="flex justify-between items-center mb-8">
                <h3 className="font-heading font-black text-white uppercase text-xs tracking-[0.2em] flex items-center gap-3">
                  <Activity size={18} className="text-cobalt-accent" /> Security Telemetry
                </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-10">
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="flex justify-between items-center px-4">
                <h3 className="font-heading font-black text-white uppercase text-xs tracking-[0.2em]">Intervention Required</h3>
                <button 
              ...
              <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                {loading ? (
                  ...
                  <div className="bg-cobalt-surface/20 border border-cobalt-border border-dashed p-16 rounded-3xl text-center flex flex-col items-center animate-in zoom-in-95">
                    <div className="w-16 h-16 bg-risk-low/10 text-risk-low rounded-full flex items-center justify-center mb-4">
                      <ShieldCheck size={32} />
                    </div>
                    <h4 className="text-white font-black text-sm uppercase tracking-widest">Environment Secured</h4>
                    <p className="text-xs text-cobalt-muted mt-2 uppercase tracking-tighter">Grok has not detected any data leaks in the current cycle.</p>
                  </div>
                )}
              </div>
            </div>

            <div className="bg-cobalt-surface/40 border border-cobalt-border p-8 rounded-[2.5rem] h-fit">
               <h3 className="font-heading font-black text-white uppercase text-xs tracking-[0.2em] mb-8">Engine Health</h3>
               <div className="space-y-8">
                  <div className="space-y-3">
                    <div className="flex justify-between text-[9px] font-black uppercase tracking-[0.3em]">
                      <span className="text-cobalt-muted italic">Neural_Load</span>
                      <span className="text-risk-low">98% OPTIMAL</span>
                    </div>
                    <div className="h-1.5 w-full bg-cobalt-bg rounded-full overflow-hidden">
                      <div className="h-full bg-risk-low w-[98%] shadow-[0_0_12px_#10B981]"></div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex justify-between text-[9px] font-black uppercase tracking-[0.3em]">
                      <span className="text-cobalt-muted italic">DB_Latent_Sync</span>
                      <span className="text-cobalt-accent">14ms VERIFIED</span>
                    </div>
                    <div className="h-1.5 w-full bg-cobalt-bg rounded-full overflow-hidden">
                      <div className="h-full bg-cobalt-accent w-[40%] shadow-[0_0_12px_#38BDF8]"></div>
                    </div>
                  </div>
                  
                  <div className="pt-6 border-t border-cobalt-border/50 mt-8">
                    <div className="p-5 bg-cobalt-bg/80 rounded-2xl border border-cobalt-border shadow-inner">
                       <div className="flex items-center gap-2 text-cobalt-accent mb-3">
                         <Zap size={14} className="fill-cobalt-accent"/>
                         <span className="text-[10px] font-black uppercase tracking-widest">Autonomous Status</span>
                       </div>
                       <p className="text-[10px] text-cobalt-muted leading-relaxed italic font-medium">
                         "Agent Grok is monitoring your perimeter. No critical remediation required at this timestamp."
                       </p>
                    </div>
                  </div>
               </div>
